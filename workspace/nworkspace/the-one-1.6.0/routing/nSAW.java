...
public class nSAW extends ActiveRouter {
	...
	public static final double c = 2.2;
	...
	public void changedConnection(Connection con) {
		...
		if (con.isUp()) {/**连接建立(连接状态改变)*/
			...
			double propertion=0;
			propertion=Math.pow(c, -separationDuration/Math.pow(SimClock.getTime(), 2));
	...
	private void updateDeliveryPredFor(DTNHost host) {
		...
		double newValue = oldValue + (1 - oldValue) * P_INIT * getHost().getpropertion(host);
