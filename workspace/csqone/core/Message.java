...
public class Message implements Comparable<Message> {
	...
	public List<DTNHost> getPath() {
		return path;
	}

	public void setPath(List<DTNHost> path) {
		this.path = path;
	}

	public int getZongcopies() {
		return zongcopies;
	}

	public void setZongcopies(int zongcopies) {
		this.zongcopies = zongcopies;
	}
