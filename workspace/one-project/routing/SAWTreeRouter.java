 ...
 *
 */
public class SAWTreeRouter extends ActiveRouter {
	...
	public SAWTreeRouter(Settings s) {
		super(s);
	 ...
	 */
	protected SAWTreeRouter(SAWTreeRouter r) {
		super(r);
	...
	public void changedConnection(Connection con) { 
		...
		getHost().updatehu(otherHost, 1);//更新历史效用表
		}*/
		}
	...
	public boolean createNewMessage(Message msg) {
		...
		msg.addProperty(SPRAY_TIMES,1);//添加字段（0开始的话，一喷发源节点的副本数就变为0了）
	...
	public void update() {
		...
		if(copiesOne.size() > 0)//自写代码
		{
			...
			/*向邻居节点分发这些消息*/
			this.tryMessagesToConnectionsCopy(copiesOne, getConnections());
		}
	...
	protected List<Message> getMessagesWithCopiesOne() {
		...
		for (Message m : getMessageCollection()) {
			...
			if (nrofCopies == 1 && buffertime>super.t_buffertime && sprayTimes<4) {
	...
	@Override
	public SAWTreeRouter replicate() {
		return new SAWTreeRouter(this);
	}
}
