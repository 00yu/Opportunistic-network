...
public class ProphetRouter extends ActiveRouter {
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) {
			DTNHost otherHost = con.getOtherNode(getHost());//获得连接对方主机
			updateDeliveryPredFor(otherHost);//更新传输预测值
			updateTransitivePreds(otherHost);//更新传递预测值
		}
	}
	...
	private void updateTransitivePreds(DTNHost host) {
		...
		Map<DTNHost, Double> othersPreds = 
			((ProphetRouter)otherRouter).getDeliveryPreds();//获得敌方路由的投递预测值集合
