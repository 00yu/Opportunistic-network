...
;
	...
	public Report(){
		...
		/**×ÔÐ´**/
		msgTtl=settings.getSetting("Group.msgTtl");
		bufferSize=(settings.getSetting("Group.bufferSize"));
		bufferSize=bufferSize.substring(0, bufferSize.indexOf("M"));
