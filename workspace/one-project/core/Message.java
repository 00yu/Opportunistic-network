...
public class Message implements Comparable<Message> {
	...
	public void setCreationTime(double setimeCreated) {
		this.timeCreated=setimeCreated;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.timeCreated = m.timeCreated;//设置创建时间
//		System.out.println("时间"+this.timeCreated);
//		System.out.println("现在时间"+SimClock.getTime());
