 ...
 *
 */
public class SAWRouter1 extends ActiveRouter {
	//我定义的变量
	...
	public static final String SAW1_NS = "SAWRouter1";
	/** Message property key */
	public static final String MSG_COUNT_PROPERTY = SAW1_NS + "." +
		"copies";
	
	protected int initialNrofCopies;
	protected boolean isBinary;

	public SAWRouter1(Settings s) {//初始化需要配置文件中信息的变量 
		super(s);
		Settings nSAWSettings = new Settings(SAW1_NS);
	 ...
	 */
	protected SAWRouter1(SAWRouter1 r) {
		super(r);
		this.beta=r.beta;
	...
	// 更新ACK表并删除多余副本
		private void checkAck(DTNHost otherHost) {
			...
			SAWRouter1 otherRouter = (SAWRouter1) mRouter;
...
//				System.out.println("old"+e.getValue().get("count")+"::new"+pNew);
	...
	@Override
	public SAWRouter1 replicate() {
		return new SAWRouter1(this);
	}
}
