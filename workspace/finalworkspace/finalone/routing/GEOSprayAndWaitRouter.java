 ...
 *
 */
public class GEOSprayAndWaitRouter extends ActiveRouter {
	//我定义的变量
	...
	public GEOSprayAndWaitRouter(Settings s) {//初始化需要配置文件中信息的变量 
		super(s);
	 ...
	 */
	protected GEOSprayAndWaitRouter(GEOSprayAndWaitRouter r) {
		super(r);
		this.beta=r.beta;
