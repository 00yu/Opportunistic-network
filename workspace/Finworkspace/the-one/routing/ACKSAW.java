 ...
 *
 */
public class ACKSAW extends ActiveRouter {
	...
	public static final String SPRAYANDWAIT_NS = "ACKSAW";
	...
	// 更新ACK表并删除多余副本
			private void checkAck(DTNHost otherHost) {
				...
				ACKSAW otherRouter = (ACKSAW) mRouter;
	...
	@Override
	public ACKSAW replicate() {
		return new ACKSAW(this);
	}
}
