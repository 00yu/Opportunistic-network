...
public class Message implements Comparable<Message> {
	...
	private int initTtl;
	/**消息的投递概率*/
	private double messageDeliveryProb;
	/**消息的次数等级*/
	private int S=0;
	...
	public double getMessageDeliveryProb(){
		return this.messageDeliveryProb;
	}
	public void setMessageDeliveryProb(double prob) {
		this.messageDeliveryProb=prob;
	}
	public int getS(){
		return this.S;
	}
