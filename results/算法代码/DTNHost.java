...
public class DTNHost implements Comparable<DTNHost> {
	...
	/**记录当前节点与其它节点相遇次数*/
	private Map<DTNHost,Integer> encounterNum;
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		this.encounterNum=new HashMap<DTNHost,Integer>();
	...
	public int getEncounterNum(DTNHost otherHost) {
		if(this.encounterNum.containsKey(otherHost)) {
			return this.encounterNum.get(otherHost);
		}
		else {
			return 0;
		}
	}
	public void updateEncounterNum(DTNHost otherHost) {
		int num=this.getEncounterNum(otherHost);
		this.encounterNum.put(otherHost, num+1);
	}
