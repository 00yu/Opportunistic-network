...
public class Proposed extends ActiveRouter {
	...
	public static final double DEFAULT_C = 0.5;
	/**
	...
	public static final String C_S = "c";
	...
	public Proposed(Settings s) {
		...
		if (sawSettings.contains(C_S)) {
			c = sawSettings.getDouble(C_S);
		}
		else {
			c = DEFAULT_C;
		}
	...
	private void updateDeliveryPredFor(DTNHost host) {
		...
		double newValue = oldValue + (1 - oldValue) * P_INIT * Math.pow(c, this.getDurationFor(host)/SimClock.getTime());
