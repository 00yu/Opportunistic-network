...
########################
# 文件目录
#path = r"F:\One平台\reports\0920"
#path = r"F:\One平台\reports\927 TTL(100;180;240;320;400;480)"
path = r"C:\Users\yudonghai\Desktop\test\TTL"
# 画图的纵坐标与横坐标的名称
COLNAME = "平均时延/s"
ROWNAME = "消息生存周期/min"
...
def painting():
    algomap = getdata()
    # 折线的颜色
    color = ["#4bacc6", "#4f81bd", "#c0504d", "#9bbb59", "#8064a2", "#4bacc6", "#D1BA74", "#FB966E", "#FFC408"]
    #折线的形状
    marker = [r"-o", r"-<", r"->", r"-^", r"-v", r"+",  r"x", r"<", r">"]
    # 图的名称
